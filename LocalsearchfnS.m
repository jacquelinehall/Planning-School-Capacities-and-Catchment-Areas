...
function [Xbest,Ybest,fbest,fintial]=LocalsearchfnS(XI,YI,x,y,pd,w1,w2,p1,p2,p3,Cv,sx,sy,L, compactmethod)
%This is for secondary schools and should be run for the single year local
%search
        ...
        if u<0.75
            for i=1:numberschools
                ...
                for z=1:length(NX)
                    ...
                    delta=obchangeX(NX,z,i,XC,YC,XI,w1,p2,p3,pd,x,y,sx,sy);
                    ...
                    if delta<deltabest
                        ...
                        % limit).
                        j1=XC(NX(z));
                        if isbalanced(XC,j1,pd,YC(j1),0,NX(z))>0 && isbalanced(XC,i,pd,YC(i),NX(z),0)<5
                            ...
                            if compactmethod==1
                                ...
                                if iscompact(XC, NX(z),i, x,y)>0.49 %Initial solution 
                            ...
                            elseif compactmethod==2
                                ...
                                if iscompact2(XC, NX(z),i, x, y)<27.3 %Initial solution 
                            ...
                            elseif compactmethod==3
                                ...
                                if iscompact3(XC, NX(z),i, x, y,sx,sy)<286.7 %Initial 
            ...
            for i=1:numberschools
                ...
                for z=1:length(NY)
                    ...
                    if delta<deltabest2
                        %Secondary schools below
                        if isbalanced(XC,i,pd,NY(z),0,0)>0 && isbalanced(XC,i,pd,NY(z),0,0)<5
                            deltabest2=delta;
                            Ybestindex=i;
                            Ybestchange=NY(z);
                        end
