function plotstudentdensitysubplotsallyears(pd,x,y,yr)
...
set(gcf,'color','w');
if k==1
    title("S1 students in 2020",'FontSize',22)
elseif k==2
    title("S2 students in 2020",'FontSize',22)
 elseif k==3   
     title("S3 students in 2020",'FontSize',22)
elseif k==4
    title("S4 students in 2020",'FontSize',22)
elseif k==5
    title("S5 students in 2020",'FontSize',22)
else
    title("S6 students in 2020",'FontSize',22)
end
...
lgd.FontSize = 22;
newUnits = 'normalized';
suptitle("students per postcode in 2019",'FontSize',22)
